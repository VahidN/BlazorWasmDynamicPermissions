...
public class UsersAccountManagerController : Controller
{
    ...
    public UsersAccountManagerController(
    ...
    public async Task<IActionResult> ChangePassword([FromBody] ChangePasswordDto model)
    {
        ...
        return succeeded ? Ok(new ApiResponseDto { Success = true }) : BadRequest(error);
    }

    [Authorize(Roles = CustomRoles.Admin), HttpGet("[action]"),
